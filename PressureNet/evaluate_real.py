...
class Viz3DPose():
    def __init__(self):
        ...
        participant_info = load_pickle("../../../data_BR/participant_info_red.p")
        ...
        self.CTRL_PNL['normalize_std'] = True  # False
    ...
    def estimate_pose(self, pmat, pc_autofil_red, model, model2):
        ...
        scores, INPUT_DICT, OUTPUT_DICT = UnpackBatchLib().unpackage_batch_kin_pass(batch, False, model,
                                                                                    self.CTRL_PNL)
...
if __name__ ==  "__main__":
    ...
    NETWORK_1 = "1.0rtojtdpth_tnhFIXN_calnoise"
    NETWORK_2 = "0.5rtojtdpth_depthestin_angleadj_tnhFIXN_calnoise"

    model_path = "/media/henry/multimodal_data_2/data/convnets/planesreg/FINAL/convnet_anglesDC_synth_184000_128b_x5pmult_" + NETWORK_1 + "_100e_00002lr.pt"
    model2_path = "/media/henry/multimodal_data_2/data/convnets/planesreg_correction/FINAL/convnet_anglesDC_synth_184000_128b_x5pmult_" + NETWORK_2 + "_100e_00002lr.pt"
    if GPU == True:
        for i in range(0, 8):
            try:
